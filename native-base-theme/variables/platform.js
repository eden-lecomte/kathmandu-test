...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'System' : 'SourceSansPro-Regular',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : 'SourceSansPro-Regular',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'System' : 'SourceSansPro-Regular',
